                              ...
                              <form action="">
                                    ...
                                    <div class="row form-row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                              ...
                                              <input type="text" class="form-control" id="inputAddress" placeholder="Category Name">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                              ...
                                              <input type="text" class="form-control" id="inputAddress" placeholder="Priority">
                                            </div>
                                        </div>
                                    </div> 
                                  </div>
                                  <div class="col-md-6 form-group">
                                      <div class="row">
                                          <div class="col-md-12 form-group">
                                              ...
                                              <textarea class="form-control" id="exampleFormControlTextarea1" rows="5" placeholder="Item Description"></textarea>
                                          </div>
                                      </div>
                                  </div>
                                </div>
                                <div class="row form-row">
                                  <div class="col-md-4 form-group">
                                        <label for="input-file-now">Category Icon</label>
                                        <input type="file" id="input-file-now" class="dropify" />      
                                   </div>
                                   <div class="col-md-8 form-group">
                                       <label for="input-file-now">Category Banner</label>
                                        <input type="file" id="input-file-now" class="dropify" />
                                    </div>
                                </div>
                                <!--end-->
