                ...
                <div class="user-profile layout-spacing">
                    <div class="widget-content widget-content-area">
                        <div class="d-flex justify-content-between">
                            <h3 class="">Info</h3>
                            <a href="create-customer.php" class="mt-2 edit-profile"> <svg
                    ...
                    <div class="widget-content widget-content-area border-top-tab">
                        ...
                        <div class="tab-content" id="borderTopContent">
                            <div class="tab-pane fade show active" id="border-top-home" role="tabpanel"
                                ...
                                <button type="button" class="btn btn-warning mb-4 mr-2 btn-sm" data-toggle="modal"
                                    data-target=".bd-example-modal-sm">Add Credits</button>
        ...
        <div class="modal-dialog modal-sm" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="mySmallModalLabel">Add Credits</h5>
                        ...
                        <div class="row form-row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label for="inputAddress">No. of Credits</label>
                            ...
                            <div class="col-md-12 form-group">
                                <label for="inputAddress">Payment Mode</label>
