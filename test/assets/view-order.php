                        ...
                        <div class="statbox widget box box-shadow">
                            <div class="widget-header">
                                <div class="row">
                                    <div class="col-xl-12 col-md-12 col-sm-12 col-12 d-flex justify-content-between align-items-center">
                                        <h4>#Order 100492</h4>
                                        <div>
                                            <button class="btn btn-warning  mr-2 btn-sm">KOT Print</button>
                                            <button class="btn btn-info  mr-2 btn-sm">Print</button>
                                            <button class="btn btn-danger  mr-2 btn-sm">Thermal Print</button>
                                        </div>
                                    </div>       
                                </div>
                            </div>
                            <div class="widget-content widget-content-area">
                                <div class="col-md-12">
                                    ...
                                    <small>
                                        fahina sheikh <br>
                                        fhb, cj, Maruthi Veethika, Udupi<br>
                                        <br>
                                        Gst No : <br>
                                        Mobile : 8660356061<br>
                                        Email  : fahinasheikh93@gmail.com
                                    </small>
                                    </p>
                                </div>    
                                <div class="col-md-12">
                                    <p>
                                        ...
                                        Delivery method : Delivery<br>
                                                                        
                                                                                                
                                        Order Date :02-12-2020 at 10-33 AM<br>
                                        Slot : 2:00 PM - 1:00 PM - 02-12-2020<br>
                                        Transaction Id : <br>
                                        Note : test<br>
                                        ...
                                        <table class="table table-hovered">
                                            ...
                                            <tbody>
                                                <tr style="font-size:10px;">
                                                    <td> <span style="color:#2196f3;font-weight:400;">Saffola Masala Oats Classic Masala</span>                                                                                                                                                          </td>
                                                    <td>500gm</td>
                                                    <td>161.01</td>
                                                    <td>1</td>
                                                    <td class="text-right">
                                                        <div class="tax" style="display:flex;">
                                                            <div class="" style="border-right: 1px solid;padding: 3px;font-size: 7px;">CGST <br> 9%   <br> ( 14.49)</div>
                                                            <div style="padding: 3px;font-size: 7px;">SGST <br>9% <br> ( 14.49)</div>
                                                        </div>
                                                    </td>
