...
Let's say that your templates are loaded from both ``.../templates/foodra``
...
``.../templates/foodra``. And if you want to extend the original template, you
might be tempted to write the following:

.. code-block:: jinja

    {# page.twig in .../templates/foodra #}
