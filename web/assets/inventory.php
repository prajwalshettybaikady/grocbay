                        ...
                        <div class="statbox widget box box-shadow">
                            ...
                            <div class="widget-content widget-content-area pill-justify-centered">
                                <ul class="nav nav-pills mb-3 mt-3 justify-content-center" id="justify-center-pills-tab" role="tablist">
                                    <li class="nav-item">
                                        <a class="nav-link active" id="justify-center-pills-home-tab" data-toggle="pill" href="#justify-center-pills-home" role="tab" aria-controls="justify-center-pills-home" aria-selected="true">Purchase Inwards</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" id="justify-center-pills-profile-tab" data-toggle="pill" href="#justify-center-pills-profile" role="tab" aria-controls="justify-center-pills-profile" aria-selected="false">Purchase Returns</a>
                                    </li>
                                 </ul>
                                <div class="tab-content" id="justify-center-pills-tabContent">
                                    <div class="tab-pane fade active show" id="justify-center-pills-home" role="tabpanel" aria-labelledby="justify-center-pills-home-tab">
                                        <div class="table-responsive">
                                            <table class="table table-hover table-striped table-checkable table-highlight-head mb-4">
                                                <thead>
                                                    <tr>
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="view-product.php"><p class="mb-0">Shaun Park</p></a>
                                                        </td>
                                                        <td>10/08/2020</td>
                                                        <td>   
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="view-product.php"><p class="mb-0">Shaun </p></a>
                                                        </td>
                                                        <td>11/08/2020</td>
                                                        <td>
                                                            <label class="switch s-icons s-outline  s-outline-success  mb-4 mr-2">
