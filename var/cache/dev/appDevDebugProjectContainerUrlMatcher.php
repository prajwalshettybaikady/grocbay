...
class appDevDebugProjectContainerUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($rawPathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/app-manager')) {
            ...
            elseif (0 === strpos($pathinfo, '/app-manager/s')) {
                ...
                if (0 === strpos($pathinfo, '/app-manager/se')) {
                    ...
                    if (0 === strpos($pathinfo, '/app-manager/search')) {
                        // search_data
                        ...
                        // search_report
                        if ('/app-manager/search-report' === $pathinfo) {
                            if (!in_array($canonicalMethod, array('GET', 'POST'))) {
                                $allow = array_merge($allow, array('GET', 'POST'));
                                goto not_search_report;
                            }

                            return array (  '_controller' => 'AppBundle\\Controller\\ReportsController::searchReportAction',  '_route' => 'search_report',);
                        }
                        not_search_report:
            ...
            if (0 === strpos($pathinfo, '/app-manager/get-')) {
                ...
                if (0 === strpos($pathinfo, '/app-manager/get-s')) {
                    // get_slot_by_id
                    ...
                    // get_user_order_id
                    if ('/app-manager/get-ser-order-id' === $pathinfo) {
                        if (!in_array($canonicalMethod, array('GET', 'POST'))) {
                            $allow = array_merge($allow, array('GET', 'POST'));
                            goto not_get_user_order_id;
                        }

                        return array (  '_controller' => 'AppBundle\\Controller\\ManagerController::getUserOrderIdAction',  '_route' => 'get_user_order_id',);
                    }
                    not_get_user_order_id:

                }

                // get_wallet_balance_ajax
                if ('/app-manager/get-wallet-balance' === $pathinfo) {
                    if (!in_array($canonicalMethod, array('GET', 'POST'))) {
                        $allow = array_merge($allow, array('GET', 'POST'));
                        goto not_get_wallet_balance_ajax;
                    }

                    return array (  '_controller' => 'AppBundle\\Controller\\ManagerController::getWalletBalanceAction',  '_route' => 'get_wallet_balance_ajax',);
                }
                not_get_wallet_balance_ajax:
            ...
            // import_ajax
            if ('/app-manager/import-ajax' === $pathinfo) {
                if (!in_array($canonicalMethod, array('GET', 'POST'))) {
                    $allow = array_merge($allow, array('GET', 'POST'));
                    goto not_import_ajax;
                }

                return array (  '_controller' => 'AppBundle\\Controller\\RestaurantController::importAjaxAction',  '_route' => 'import_ajax',);
            }
            not_import_ajax:
            ...
            // remove_banner
            if (0 === strpos($pathinfo, '/app-manager/remove-banner') && preg_match('#^/app\\-manager/remove\\-banner/(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
                if (!in_array($canonicalMethod, array('GET', 'POST'))) {
                    $allow = array_merge($allow, array('GET', 'POST'));
                    goto not_remove_banner;
                }

                return $this->mergeDefaults(array_replace($matches, array('_route' => 'remove_banner')), array (  '_controller' => 'AppBundle\\Controller\\ManagerController::removeBannerAction',));
            }
            not_remove_banner:
            ...
            // add_addon
            if ('/app-manager/add-addon' === $pathinfo) {
                if (!in_array($canonicalMethod, array('GET', 'POST'))) {
                    $allow = array_merge($allow, array('GET', 'POST'));
                    goto not_add_addon;
                }

                return array (  '_controller' => 'AppBundle:Addon:createAddon',  '_route' => 'add_addon',);
            }
            not_add_addon:
            ...
            // addon_manager_ajax
            if ('/app-manager/manage-addon-ajax' === $pathinfo) {
                if (!in_array($canonicalMethod, array('GET', 'POST'))) {
                    $allow = array_merge($allow, array('GET', 'POST'));
                    goto not_addon_manager_ajax;
                }

                return array (  '_controller' => 'AppBundle:Addon:viewAddonAjax',  '_route' => 'addon_manager_ajax',);
            }
            not_addon_manager_ajax:

            // commission_order_report
            if ('/app-manager/report/commission' === $pathinfo) {
                return array (  '_controller' => 'AppBundle\\Controller\\ReportsController::commissionAction',  '_route' => 'commission_order_report',);
            }

            // filter_commission
            if ('/app-manager/filter-commission' === $pathinfo) {
                if (!in_array($canonicalMethod, array('GET', 'POST'))) {
                    $allow = array_merge($allow, array('GET', 'POST'));
                    goto not_filter_commission;
                }

                return array (  '_controller' => 'AppBundle\\Controller\\ReportsController::filterCommissionAction',  '_route' => 'filter_commission',);
            }
            not_filter_commission:

            // view_addon
            if ('/app-manager/view-addon' === $pathinfo) {
                if (!in_array($canonicalMethod, array('GET', 'POST'))) {
                    $allow = array_merge($allow, array('GET', 'POST'));
                    goto not_view_addon;
                }

                return array (  '_controller' => 'AppBundle:Addon:viewAddon',  '_route' => 'view_addon',);
            }
            not_view_addon:

            // delete_addon
            if ('/app-manager/delete-addon' === $pathinfo) {
                if (!in_array($canonicalMethod, array('GET', 'POST'))) {
                    $allow = array_merge($allow, array('GET', 'POST'));
                    goto not_delete_addon;
                }

                return array (  '_controller' => 'AppBundle:Addon:deleteAddon',  '_route' => 'delete_addon',);
            }
            not_delete_addon:
        ...
        elseif (0 === strpos($pathinfo, '/api/app-manager/get-functionality')) {
            ...
            // delete_variation_images
            if (0 === strpos($pathinfo, '/api/app-manager/get-functionality/delete-variation-images') && preg_match('#^/api/app\\-manager/get\\-functionality/delete\\-variation\\-images/(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
                if (!in_array($canonicalMethod, array('GET', 'POST'))) {
                    $allow = array_merge($allow, array('GET', 'POST'));
                    goto not_delete_variation_images;
                }

                return $this->mergeDefaults(array_replace($matches, array('_route' => 'delete_variation_images')), array (  '_controller' => 'AppBundle\\Controller\\ApiController::deletevariationimagesAction',));
            }
            not_delete_variation_images:
