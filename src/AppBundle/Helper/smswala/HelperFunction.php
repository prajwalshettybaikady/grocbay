...
$key=trim($template['otp']);
        if($mobile!=null && $message!=null):
         ...
         $ch = curl_init();
        curl_setopt($ch,CURLOPT_URL,'http://smswala.dakiyya.com/submitsms.jsp?user=PARAMTR&key=e840c70de6XX&senderid=DALERT&mobile=+91'.$mobile.'&message='.$message.'&accusage=6');
